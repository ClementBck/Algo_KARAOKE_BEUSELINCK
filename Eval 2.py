#Création de la classe Karaoke
class Karaoke:
    def __init__(self,nombreChansons, listeChansons, listeJoueurs):
        self.nombreChansons = nombreChansons
        self.listeChansons = listeChansons
...
class Player:
    ...
    def ajouterScore(self, numMusique, nouveauScore):
        ...
        if (nouveauScore < 50 or nouveauScore > 100):
            print("Le score rentrer n'est pas valide !")
